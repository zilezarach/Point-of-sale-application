  ...
  const orderData = [21,22,12,11,15,12,16,12,12,12,13,21];
   return (
    <div className="p-4 bg-white rounded shadow-md">
      <h2 className="text-2xl font-bold mb-4 text-rose-500 no-underline hover:underline">Sales Overview</h2>
      <SalesChart salesData={salesData} customerData={customerData} orderData={orderData}/>
    </div>
  );
